var appEnvironment = process.env.npm_config_target || "dev";
...
app.get("*", function(req, res) {
    console.log("path.join(__dirname, appDirectory+'/', 'index.html'):", path.join(__dirname, appDirectory+'/', appEnvironment === 'dev' ? 'index_dev.html' : 'index.html'))
    res.sendFile(path.join(__dirname, appDirectory+'/', appEnvironment === 'dev' ? 'index_dev.html' : 'index.html'));
});
// -----------------------------------------------------------------------------
