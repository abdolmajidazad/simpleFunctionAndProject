 ...
 * @type {angular.Module}
 */
var myApp = angular.module('myApp', ['ui.router', 'pascalprecht.translate', 'ngSanitize', 'ui.bootstrap.contextMenu', 'angular-progress-arc', 'updateMeta', 'colorpicker', 'ngMask', 'ui.sortable', "relativeDate", "ngRateIt", 'vcRecaptcha']);
// 'angularSails.io'
...
myApp.config(["$stateProvider", "$urlRouterProvider", "$controllerProvider", "$compileProvider", "$filterProvider", "$provide", function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide) {
    ...
    var environment = window.enviroment;
    ...
    $stateProvider.state('root', {
        ...
        views: {
            ...
            // "body@" : {},
            "header@root": {
                templateUrl: '' + (environment === 'development' ? 'views/tpl/header/header.html?1535267630534' : 'library/pageBundle/html/header.min.html?1535267630534'),
                controller: 'headerController'
            },
            "footer@root": {
                templateUrl: '' + (environment === 'development' ? 'views/tpl/footer/footer.html?1535267630534' : 'library/pageBundle/html/footer.min.html?1535267630534'),
                controller: 'footerController'
            },
            "rightSidebar@root": {
                templateUrl: '' + (environment === 'development' ? 'views/tpl/sidebar/right/rightSidebar.html?1535267630534' : 'library/pageBundle/html/rightSidebar.min.html?1535267630534'),
                controller: 'rightSidebarController'
            },
            "leftSidebar@root": {
                templateUrl: '' + (environment === 'development' ? 'views/tpl/sidebar/left/leftSidebar.html?1535267630534' : 'library/pageBundle/html/leftSidebar.min.html?1535267630534'),
                controller: 'leftSidebarController'
            },
            "menubar@root": {
                templateUrl: '' + (environment === 'development' ? 'views/tpl/menubar/menubar.html?1535267630534' : 'library/pageBundle/html/menubar.min.html?1535267630534'),
                controller: 'leftSidebarController'
            }
        },
        resolve: {
        ...
        views: {
            "afterLogin": {
                templateUrl: '' + (environment === 'development' ? "views/pages/home/home.html?1535267630534" : 'library/pageBundle/html/home.min.html?1535267630534'),
                controller: "HomeCtrl"
            }
        },
        ...
        views: {
            "afterLogin": {
                templateUrl: '' + (environment === 'development' ? "views/pages/aboutUs/aboutUs.html?1535267630534" : 'library/pageBundle/html/aboutUs.min.html?1535267630534'),
        ...
        resolve: {
            deps: ['$q', '$rootScope', function deps($q, $rootScope) {
                var deferred = $q.defer();
                var dependencies = appIncludeFilesJson[appEnvironment].pages.aboutUs.js;
        ...
        views: {
            "beforeLogin": {
                templateUrl: '' + (environment === 'development' ? "views/pages/404/404.html?1535267630534" : 'library/pageBundle/html/404.min.html?1535267630534'),
...
myApp.controller("rootController", ['$scope', function ($scope) {
    ...
    $scope.getTemplateUrl = function () {
        return '' + (environment === 'development' ? 'views/tpl/main/after-login.html?1535267630534' : 'library/pageBundle/html/after-login.min.html?1535267630534');
    };
}]);
